...
export default class NewChatReminderScene {
    private newChatReminder
    constructor() {
        this.newChatReminder = new Scenes.BaseScene('new_chat_reminder');
        
        // this.newChatReminder.action(THEATER_ACTION, (ctx) => {
    ...
    enter(chats?: Array<{chatId: number, chatName: string}>){
        ...
        this.newChatReminder.enter((ctx) => {
